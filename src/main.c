...
int main()
{
    ...
    CheckFile("Assets/Shaders/BasicVertices.vert");
    CheckFile("Assets/Shaders/BasicColor.frag");
    CheckFile("Assets/Pictures/atlas.png");
    CheckFile("Assets/Pictures/selected.png");
    ...
    if (!stbi_info("Assets/Pictures/atlas.png", &atlasWidth, &atlasHeight,
                   &atlasChannels))
