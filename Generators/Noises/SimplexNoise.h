...
extern "C"
{
    ...
    int open_simplex_noise_init_perm(struct osn_context *ctx, int16_t p[],
                                     int nelements);
    double open_simplex_noise2(struct SimplexNoiseObj *noise, double x,
                               double y);
    double open_simplex_noise3(const struct osn_context *ctx, double x,
                               double y, double z);
    double open_simplex_noise4(const struct osn_context *ctx, double x,
